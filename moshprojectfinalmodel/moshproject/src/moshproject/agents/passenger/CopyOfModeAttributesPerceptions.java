...
public class CopyOfModeAttributesPerceptions {
...
///	private double privateModeEfficiencyCognitive;
	...
	public CopyOfModeAttributesPerceptions(Mode prefferedMode){
		...
		///
		prefferedMode.addAttribute(Constants.vpReliability);
	//	prefferedMode.setValueToAttribute(Constants.vpReliability, );
...
/////UnPleasant Affective counts
			public double getPrivateVPReliabilityUnpleasantAffectiveCounts(){
				int allCounts =0;				
				if (prefferedMode instanceof PersonalVehicle)	{	
			...
			public double getCycleVPReliabilityUnpleasantAffectiveCounts(){
				int allCounts =0;				
				if (prefferedMode instanceof Cycle)	{	
...
/////NEitherPleasant Nor UnPlaesant
			public double getPrivateVPReliabilityNeitherPleasantNorUnpleasantAffectiveCounts(){
				int allCounts =0;				
				if (prefferedMode instanceof PersonalVehicle)	{	
			...
			public double getCycleVPReliabilityNeitherPleasantNorUnpleasantAffectiveCounts(){
				int allCounts =0;				
				if (prefferedMode instanceof Cycle)	{	
...
///////Pleasant
			public double getPrivateVPReliabilityPleasantAffectiveCounts(){
				int allCounts =0;				
				if (prefferedMode instanceof PersonalVehicle)	{	
			...
			public double getCycleVPReliabilityPleasantAffectiveCounts(){
				int allCounts =0;				
				if (prefferedMode instanceof Cycle)	{	
...
/////Neither Pleasant nor Unplesanat Satsifaction Cognitive counts
...
///Pleasant Satisfaction Cognitive
